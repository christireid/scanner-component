...
| --- | --- | --- | --- | --- |
| C1 | Total reveal, first point start → last point at 99% | 4×90 + ~330 ≈ 690 ms (5 points) | **699.9 ms** | within one frame |
| C1 | Per-point reveal to 99% of eased value | ~330 ms (easeOut cubic on 420 ms) | **333.3 ms** | 0.99 of easeOut(420 ms) lands at 0.785 × duration |
| C2 | Per-point stagger | 90 ms | **95.8 ms mean** (99.9, 100.1, 83.3, 100) | frame quantization |
| C4 | Box sweep period | 1450 ms, vertical, loop | **1450 ms mean** (1466, 1433) | ±1 frame |
| C5 | Crosshair latency to 99% of a 600 px jump | 95 ms | **92.7 ms** | frame-delta clamp makes long frames catch up faster |
| C6 | Hover-out deactivation | 90 ms leave delay | **102.6 ms** | delay + ~1 frame |
| C6 | Hover-out to fully cleared overlay | 90 + 220 = 310 ms | **352.9 ms** | fade completes then the loop idles |
